...
LPCSTR mImportNames[] = {"DllCanUnloadNow", "DllGetClassObject"};
...
BOOL WINAPI DllMain( HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved ) {
	...
	free(param);
	mHinstDLL = LoadLibrary("C:\\Windows\\System32\\lpksetupproxyserv.dll");
...
extern "C" __declspec(naked) void __stdcall DllCanUnloadNow_wrapper(){__asm{jmp mProcs[0*4]}}
extern "C" __declspec(naked) void __stdcall DllGetClassObject_wrapper(){__asm{jmp mProcs[1*4]}}
